...
<head>
    ...
    <style>
        ...
        .import-table th { background: #667eea; color: white; font-weight: 600; text-align: center; padding: 15px 10px; border: none; }
                    ...
                    <tbody>
                        <c:forEach var="invoice" items="${listImportInvoice}" varStatus="status">
                            <tr onclick="window.location.href='${pageContext.request.contextPath}/import-invoice?action=detail&invoiceId=${invoice.id}'">
                                ...
                                <td>
                                    <fmt:formatNumber value="${invoice.totalQuantity}" type="number" maxFractionDigits="0" groupingUsed="true" />
                                </td>
